<x-app-layout>
    @php $pageTitle = 'Portal Informasi Publik' @endphp
                            ...
                            <div class="card-body card-dashboard">
                                ...
                                <div class="d-flex flex-md-row justify-content-between align-items-center mb-2 flex-wrap"
                                    ...
                                    <div class="d-flex align-items-center" style="gap: 0.75rem">
                                        <a href="{{ route('dashboard.other-informations.public-information-portals.create') }}"
                                    ...
                                    <form
                                        action="{{ route('dashboard.other-informations.public-information-portals.mass-destroy') }}"
                                ...
                                <div class="table-responsive">
                                    <table class="table-striped table-bordered table-custom table-align-middle table">
                                        @php
                                            $column = ['Logo', 'Nama Portal', 'Deskripsi', 'Link Website', 'Riwayat'];
                                        @endphp
        ...
        <script>
            $(document).ready(function() {
                const table = $('.table-custom').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('dashboard.other-informations.public-information-portals.data') }}",
                    columns: [{
                            data: 'action',
                            orderable: false,
                            searchable: false,
