<x-app-layout>
    @php $pageTitle = 'Tambah Data Dokumen' @endphp
                    ...
                    <div class="card">
                        ...
                        <div class="card-content show collapse">
                            <div class="card-body card-dashboard">
                                ...
                                <form class="form"
                                    action="{{ route('dashboard.other-informations.download-center.store') }}"
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="document_type" id="document_type"
                                                ...
                                                placeholder="Masukkan jenis dokumen" value="{{ old('document_type') }}">
                                            @error('document_type')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="description" class="form-control ckeditor @error('description') is-invalid @enderror"
                                                placeholder="Masukkan deskripsi" name="description">{{ old('description') }}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="status"
                                                ...
                                                <option value="archive"
                                                    {{ old('status') == 'archive' ? 'selected' : '' }}>
                                                    Arsip</option>
                                                <option value="internal"
                                                    {{ old('status') == 'internal' ? 'selected' : '' }}>
