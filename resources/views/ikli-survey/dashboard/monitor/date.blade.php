<x-app-layout>
    @php $pageTitle = 'Monitoring Harian';    @endphp
                            ...
                            <div class="card-body card-dashboard">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div id="accordionDate">

                                            @forelse ($countDate as $date)
                                                @php
                                                    $dateId = 'date-' . str_replace('-', '', $date->survey_date);
                                                    $districts = $countDistrict->get($date->survey_date, collect());
                                                @endphp
                                                ...
                                                <div class="card mb-1">
                                                            ...
                                                            <button
                                                                ...
                                                                <div class="d-flex flex-lg-row justify-content-between align-items-center flex-wrap"
                                                                    ...
                                                                    <span>
                                                                        ...
                                                                        {{ \Carbon\Carbon::parse($date->survey_date)->translatedFormat('d F Y') }}
                                                                    </span>

                                                                    <span class="badge bg-indigo badge-pill">
                                                                        {{ number_format($date->total, 0, ',', '.') }}
                                                                        Responden
                                                                    </span>
                                                                </div>
                                                            </button>
                                                    ...
                                                    <div id="collapse-{{ $dateId }}"
                                                        class="collapse js-monitor-collapse"
                                                        aria-labelledby="heading-{{ $dateId }}">

                                                        <div class="card-body">

                                                            {{-- Accordion Per Kecamatan --}}
                                                            <div id="accordionDistrict-{{ $dateId }}">

                                                                @forelse ($districts as $district)
                                                                    @php
                                                                        $districtId =
                                                                            $dateId . '-district-' . $loop->iteration;

                                                                        $villages = $countVillage
                                                                            ->get($date->survey_date, collect())
                                                                            ->get($district->district, collect());
                                                                    @endphp
                                                                    ...
                                                                    <div class="card mb-1">
                                                                        <div class="card-header py-0"
                                                                            ...
                                                                            <h6 class="mb-0">
                                                                                <button
                                                                                    class="btn btn-link btn-block text-left text-decoration-none p-0"
                                                                                    type="button"
                                                                ...
                                                                @empty
                                                                    <div
                                                                        class="alert alert-light border mb-0 text-center">
                                                                        Belum ada data kecamatan pada tanggal ini.
                                                                    </div>
                                                                @endforelse
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="mt-3 d-flex justify-content-center">
                                            {{ $countDate->links('pagination::bootstrap-4') }}
                                        </div>
                                    </div>
                                </div>
                            </div>
