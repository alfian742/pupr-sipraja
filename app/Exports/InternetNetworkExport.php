...
class InternetNetworkExport implements
    FromQuery,
    WithHeadings,
    WithMapping,
    WithColumnFormatting
{
    ...
    {
        $query = InternetNetwork::query()
            ->join('questionnaire_respondents', 'questionnaire_respondents.id', '=', 'internet_networks.respondent_id')
            ->select([
                ...
                'internet_networks.physical_availability_score',
                'internet_networks.quality_score',
                'internet_networks.suitability_score',
                'internet_networks.utilization_score',
                'internet_networks.expectation_score',
            ])
