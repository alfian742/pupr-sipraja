...
class WasteManagementSystemController extends Controller
{
    /**
     * Key routing (digunakan untuk dynamic route name).
     */
    protected string $key = 'waste-management-system';

    /**
     * Label jenis infrastruktur (digunakan untuk filtering pertanyaan & view).
     */
    protected string $infrastructureType = 'Prasarana Persampahan';

    /**
     * Model yang digunakan oleh controller.
     */
    protected string $model = WasteManagementSystem::class;
