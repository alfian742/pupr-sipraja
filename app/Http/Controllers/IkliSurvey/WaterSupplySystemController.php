...
class WaterSupplySystemController extends Controller
{
    /**
     * Key routing (digunakan untuk dynamic route name).
     */
    protected string $key = 'water-supply-system';

    /**
     * Label jenis infrastruktur (digunakan untuk filtering pertanyaan & view).
     */
    protected string $infrastructureType = 'Prasarana Air Minum';

    /**
     * Model yang digunakan oleh controller.
     */
    protected string $model = WaterSupplySystem::class;
