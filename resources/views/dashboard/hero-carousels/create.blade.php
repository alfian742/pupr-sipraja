                    ...
                    <div class="card">
                        ...
                        <div class="card-content show collapse">
                            <div class="card-body card-dashboard">
                                ...
                                <form class="form" action="{{ route('dashboard.hero-carousels.store') }}"
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-8">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea rows="7" id="description" class="form-control @error('description') is-invalid @enderror"
                                                        placeholder="Contoh: Dokumentasi gedung dan lingkungan DPUPR Kabupaten Lombok Tengah." name="description">{{ old('description') }}</textarea>
                                                    @error('description')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <label for="image_path">Gambar Carousel <span
                                                            class="text-danger">*</span></label>
