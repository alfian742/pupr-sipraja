                            ...
                            <div class="card-body card-dashboard">
                                ...
                                <div class="d-flex flex-md-row justify-content-between align-items-center mb-2 flex-wrap"
                                    ...
                                    <div class="d-flex align-items-center" style="gap: 0.75rem">
                                        <a href="{{ route('dashboard.monev.finances.contracts.create') }}"
                                            class="btn btn-indigo">
                                            <i class="fa fa-plus"></i> <span class="d-none d-md-inline">Tambah</span>
                                        </a>

                                        <a href="{{ route('dashboard.monev.finances.contracts.recap') }}"
                                            class="btn btn-info">
                                            <i class="fa fa-folder"></i> <span class="d-none d-md-inline">Rekap</span>
                                        </a>
                                    ...
                                    @if (Auth::user()->role === 'superadmin')
                                        <form action="{{ route('dashboard.monev.finances.contracts.mass-destroy') }}"
                                ...
                                <div class="row mb-2">
                                    @include('dashboard.monev.finances.contracts.partials.import')
                                    @include('dashboard.monev.finances.contracts.partials.export')
                                </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                const table = $('.table-custom').DataTable({
                    ...
                    searching: true,
                    ajax: {
                        url: "{{ route('dashboard.monev.finances.contracts.data') }}",
                        type: "POST",
                        data: function(d) {
                            d._token = "{{ csrf_token() }}";
                        }
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                */
                ...
                const checkImportUrl = "{{ route('dashboard.monev.finances.contracts.check-import') }}";
                            ...
                            .then(res => {
                                if (res && res.ready) {
                                    ...
                                    swal({
                                        ...
                                        text: 'Data kontrak berhasil diimpor ke sistem.',
                                        icon: 'success',
                                    }).then(() => {
                ...
                */
                ...
                const checkUrl = "{{ route('dashboard.monev.finances.contracts.check-export') }}";
                ...
                if (exportForm && btnExport) {
                    btnExport.addEventListener('click', (e) => {
                        ...
                        swal({
                            title: 'Ekspor Data?',
                            text: `Data akan diproses di server dalam format ${selectedFormat} berdasarkan rentang tanggal kontrak. Setelah selesai, file dapat diunduh.`,
                            icon: 'info',
