<x-app-layout>
    @php $pageTitle = 'Edit Indikator Kinerja Daerah' @endphp
                        ...
                        <div class="card-content show collapse">
                            <div class="card-body card-dashboard">
                                ...
                                <form class="form" action="{{ $routeList->update }}" method="POST" id="myForm">
                                    ...
                                    <div class="form-body">
                                        <input type="hidden" name="indicator_type" value="{{ $data->indicator_type }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="indicator_code"
                                                ...
                                                value="{{ old('indicator_code', $data->indicator_code) }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="indicator_name" class="form-control @error('indicator_name') is-invalid @enderror"
                                                placeholder="Contoh: Indeks Kepuasan Layanan Infrastruktur (IKLI)" name="indicator_name">{{ old('indicator_name', $data->indicator_name) }}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="indicator_unit"
                                                ...
                                                name="indicator_unit"
                                                value="{{ old('indicator_unit', $data->indicator_unit) }}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="baseline_year"
                                                        ...
                                                        value="{{ old('baseline_year', $data->baseline_year) }}">
                                                    @error('baseline_year')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" step="0.01" id="baseline_value"
                                                        ...
                                                        value="{{ old('baseline_value', $data->baseline_value) }}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="measurement_year"
                                                        ...
                                                        value="{{ old('measurement_year', $data->measurement_year) }}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="period"
                                                        ...
                                                        <option value="" disabled
                                                            {{ old('period', $data->period) ? '' : 'selected' }}>--
                                                            Pilih Periode --</option>
                                                        <option value="Triwulan I"
                                                            {{ old('period', $data->period) == 'Triwulan I' ? 'selected' : '' }}>
                                                            Triwulan I</option>
                                                        <option value="Triwulan II"
                                                            {{ old('period', $data->period) == 'Triwulan II' ? 'selected' : '' }}>
                                                            Triwulan II</option>
                                                        <option value="Triwulan III"
                                                            {{ old('period', $data->period) == 'Triwulan III' ? 'selected' : '' }}>
                                                            Triwulan III</option>
                                                        <option value="Triwulan IV"
                                                            {{ old('period', $data->period) == 'Triwulan IV' ? 'selected' : '' }}>
                                                            Triwulan IV</option>
                                                    </select>
                                                    @error('period')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" step="0.01" id="target_value"
                                                        ...
                                                        value="{{ old('target_value', $data->target_value) }}">
                                                    @error('target_value')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" step="0.01" id="achievement_value"
                                                        ...
                                                        value="{{ old('achievement_value', $data->achievement_value) }}">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" step="0.01" id="performance_value"
                                                        ...
                                                        value="{{ old('performance_value', $data->performance_value) }}">
