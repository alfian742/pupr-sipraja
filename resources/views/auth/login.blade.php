<x-auth-layout>
    @php $pageTitle = __('Log In'); @endphp
                    ...
                    <div class="auth-form-area">
                            ...
                            <fieldset class="form-group mb-2">
                                <div class="captcha-box">
                                    <div class="captcha-question" aria-hidden="true">
                                        <span>{{ session('captcha_number_1') }}</span>
                                        <span class="mx-2">+</span>
                                        <span>{{ session('captcha_number_2') }}</span>
                                        <span class="mx-2">=</span>
                                    </div>

                                    <x-text-input id="captcha_answer" type="text" name="captcha_answer"
                                        class="form-control captcha-input {{ $errors->has('captcha_answer') ? 'is-invalid' : '' }}"
                                        inputmode="numeric" pattern="[0-9]*" maxlength="2" autocomplete="off"
                                        aria-label="Captcha" placeholder="?" />
                                </div>

                                <x-input-error :messages="$errors->get('captcha_answer')" class="invalid-feedback d-block" />
                            </fieldset>
                            ...
                            <div class="form-group row align-items-center mb-2">
                                ...
                                <div class="col-12 col-sm-6 mb-1 mb-sm-0">
                                    <fieldset class="mb-0">
                                        ...
                                        <label for="remember-me" class="mb-0 auth-small-text">
                                            {{ __('Remember me') }}
                                        </label>
                                    </fieldset>
                                </div>
                        ...
                        @if (Route::has('register'))
                            <div class="auth-register">
                                ...
                                <a class="auth-link font-weight-bold" href="{{ route('register') }}">
                                    {{ __('Register') }}
                                </a>
                            </div>
                        @endif
