                ...
                <div class="col-12 col-md-10 col-lg-8 col-xl-6">
                    <div class="hero-card text-center mx-auto">
                        ...
                        <p class="hero-text mb-4 fst-italic">
                            ...
                            Kontribusi Anda sangat berarti bagi kami.
                        </p>
                        <a href="{{ route('ikli-survey.home') }}" class="btn btn-outline-secondary rounded-pill">
                            <i class="fa-solid fa-arrow-left me-2"></i>Halaman Utama
                        </a>
                    </div>
                </div>
            </div>
