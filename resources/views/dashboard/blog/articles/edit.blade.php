                    ...
                    <div class="card">
                        ...
                        <div class="card-content show collapse">
                            <div class="card-body card-dashboard">
                                ...
                                <form class="form" action="{{ route('dashboard.blog.articles.update', $data->id) }}"
                                                            ...
                                                            <select id="blog_category_id" name="blog_category_id"
                                                                ...
                                                                @foreach ($categories as $category)
                                                                    <option value="{{ $category->id }}"
                                                                        @selected(old('blog_category_id', $data->blog_category_id) == $category->id)>
                                                                        {{ $category->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea rows="14" id="content" class="form-control ckeditor @error('content') is-invalid @enderror"
                                                                placeholder="Tulis konten artikel di sini." name="content">{{ old('content', $data->content) }}</textarea>
                                                            @error('content')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-append">
                                                                    <button
                                                                        class="btn btn-outline-danger {{ $data->thumbnail ? '' : 'd-none' }}"
                                                    ...
                                                    <div class="card-body">
                                                            ...
                                                            <select id="user_id" name="user_id"
                                                                ...
                                                                @foreach ($users as $user)
                                                                    <option value="{{ $user->id }}"
                                                                        @selected(old('user_id', $data->user_id) == $user->id)>
                                                                        {{ $user->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select id="status" name="status"
                                                                ...
                                                                <option value="draft" @selected(old('status', $data->status) == 'draft')>
                                                                    Draft
                                                                </option>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="d-flex align-items-center mt-1"
                                                                ...
                                                                <input type="checkbox"
                                                                    ...
                                                                    value="1" @checked(old('is_featured', $data->is_featured) == 1)>
                                                ...
                                                <div class="card border-indigo">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            ...
                                                            <small class="text-muted">
                                                                Slug akan diperbarui otomatis berdasarkan judul artikel.
                                                            </small>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    @push('scripts')
        ...
        <script>
            $(document).ready(function() {
                ...
                const currentThumbnail = "{{ $currentThumbnail }}";
                const hasCurrentThumbnail = "{{ $data->thumbnail ? '1' : '0' }}";

                const $inputThumbnail = $('#thumbnail');
                const $btnRemove = $('#btnRemoveThumbnail');
                const $previewImage = $('#previewImage');
                const $frontendError = $('#frontendThumbnailError');
                const $removeThumbnail = $('#remove_thumbnail');
                ...
                function resetInput() {
                    ...
                    $removeThumbnail.val("0");

                    if (hasCurrentThumbnail === "1") {
                        $btnRemove.removeClass('d-none');
                        $previewImage.attr('src', currentThumbnail);
                    } else {
                        $btnRemove.addClass('d-none');
                        $previewImage.attr('src', defaultThumbnail);
                    }
                }
