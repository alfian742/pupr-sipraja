    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            @if (request()->routeIs('ikli-survey.*'))
                <li class="nav-item @if (request()->routeIs('ikli-survey.dashboard.index')) active @endif"><a
                        href="{{ route('ikli-survey.dashboard.index') }}"><i class="icon-grid"></i><span
                            class="menu-title">{{ __('Dashboard') }}</span></a>
                </li>

                <li class="nav-item @if (request()->routeIs('ikli-survey.dashboard.about')) active @endif"><a
                        href="{{ route('ikli-survey.dashboard.about') }}"><i class="icon-info"></i><span
                            class="menu-title">Tentang</span></a>
                </li>

                <li class="navigation-header">
                    <span>Survei</span>
                    <i class="ft-more-horizontal ft-minus" data-toggle="tooltip" data-placement="right"
                        data-original-title="Survei"></i>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="menu-content">
                        <li class="@if (request()->routeIs('ikli-survey.dashboard.questionnaire.monitor.date')) active @endif">
                            <a class="menu-item" href="{{ route('ikli-survey.dashboard.questionnaire.monitor.date') }}">
                                Harian
                            </a>
                        </li>
                        <li class="@if (request()->routeIs('ikli-survey.dashboard.questionnaire.monitor.district')) active @endif">
                            <a class="menu-item"
                                href="{{ route('ikli-survey.dashboard.questionnaire.monitor.district') }}">
                                Wilayah
                            </a>
                        </li>
                    </ul>
                ...
                <li class="nav-item">
                    ...
                    <ul class="menu-content">
                        <li class="@if (request()->routeIs('ikli-survey.dashboard.questionnaire.transportation-terminal.*')) active @endif">
                            <a class="menu-item"
                                href="{{ route('ikli-survey.dashboard.questionnaire.transportation-terminal.index') }}">
                                Prasarana Terminal
                            </a>
                        </li>
                        <li class="@if (request()->routeIs('ikli-survey.dashboard.questionnaire.road.*')) active @endif">
                            <a class="menu-item" href="{{ route('ikli-survey.dashboard.questionnaire.road.index') }}">
                                Jaringan Jalan
                            </a>
                        </li>
                        <li class="@if (request()->routeIs('ikli-survey.dashboard.questionnaire.irrigation.*')) active @endif">
                            <a class="menu-item"
                                href="{{ route('ikli-survey.dashboard.questionnaire.irrigation.index') }}">
                                Jaringan Irigasi
                            </a>
                        </li>
                        <li class="@if (request()->routeIs('ikli-survey.dashboard.questionnaire.water-supply-system.*')) active @endif">
                            <a class="menu-item"
                                href="{{ route('ikli-survey.dashboard.questionnaire.water-supply-system.index') }}">
                                Prasarana Air Minum
                            </a>
                        </li>
                        <li class="@if (request()->routeIs('ikli-survey.dashboard.questionnaire.wastewater-management-system.*')) active @endif">
                            <a class="menu-item"
                                href="{{ route('ikli-survey.dashboard.questionnaire.wastewater-management-system.index') }}">
                                Prasarana Air Limbah
                            </a>
                        </li>
                        <li class="@if (request()->routeIs('ikli-survey.dashboard.questionnaire.waste-management-system.*')) active @endif">
                            <a class="menu-item"
                                href="{{ route('ikli-survey.dashboard.questionnaire.waste-management-system.index') }}">
                                Prasarana Persampahan
                            </a>
                        </li>
                        <li class="@if (request()->routeIs('ikli-survey.dashboard.questionnaire.power-grid.*')) active @endif">
                            <a class="menu-item"
                                href="{{ route('ikli-survey.dashboard.questionnaire.power-grid.index') }}">
                                Jaringan Listrik
                            </a>
                        </li>
                        <li class="@if (request()->routeIs('ikli-survey.dashboard.questionnaire.internet-network.*')) active @endif">
                            <a class="menu-item"
                                href="{{ route('ikli-survey.dashboard.questionnaire.internet-network.index') }}">
                                Jaringan Internet
                            </a>
                        </li>
                        <li class="@if (request()->routeIs('ikli-survey.dashboard.questionnaire.infrastructure-improvement.*')) active @endif">
                            <a class="menu-item"
                                href="{{ route('ikli-survey.dashboard.questionnaire.infrastructure-improvement.index') }}">
                ...
                <li class="nav-item @if (request()->routeIs('ikli-survey.dashboard.questionnaire.respondent.index')) active @endif">
                    <a href="{{ route('ikli-survey.dashboard.questionnaire.respondent.index') }}">
                        <i class="icon-user"></i>
                        <span class="menu-title">Sampel Responden</span>
                    </a>
                </li>

                <li class="nav-item @if (request()->routeIs('ikli-survey.dashboard.questionnaire.question.*')) active @endif">
                    <a href="{{ route('ikli-survey.dashboard.questionnaire.question.index') }}">
                        <i class="icon-question"></i>
                        <span class="menu-title">Daftar Pertanyaan</span>
                    </a>
                </li>
            @else
                ...
                <li class="nav-item">
                    ...
                    <ul class="menu-content">
                        <li class="@if (request()->routeIs('dashboard.monev.finances.ls-payments.*')) active @endif">
                            <a class="menu-item"
                                href="{{ route('dashboard.monev.finances.ls-payments.index') }}">Data
                                LS</a>
                        </li>
                        ...
                        <li class="@if (request()->routeIs('dashboard.monev.finances.realizations.*')) active @endif">
                            <a class="menu-item"
                                href="{{ route('dashboard.monev.finances.realizations.index') }}">Data
                                Realisasi</a>
                        </li>
                    </ul>
                </li>
