                            ...
                            <div class="card-body card-dashboard">
                                ...
                                <div class="d-flex flex-md-row justify-content-between align-items-center mb-2 flex-wrap"
                                    ...
                                    <div class="d-flex align-items-center" style="gap: 0.75rem">
                                        <a href="{{ route('dashboard.hero-carousels.create') }}" class="btn btn-indigo">
                                            <i class="fa fa-plus"></i> Tambah
                                        </a>
                                    </div>

                                    <form action="{{ route('dashboard.hero-carousels.mass-destroy') }}" method="POST"
                                        class="d-flex align-items-center" style="gap: 0.75rem">
                                        @csrf
        ...
        <script>
            $(document).ready(function() {
                const table = $('.table-custom').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('dashboard.hero-carousels.data') }}",
                    columns: [{
                            data: 'action',
                            orderable: false,
                            searchable: false,
