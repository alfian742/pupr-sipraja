...
class IrrigationExport implements
    FromQuery,
    WithHeadings,
    WithMapping,
    WithColumnFormatting
{
    ...
    public function query()
    {
        $query = Irrigation::query()
            ->join('questionnaire_respondents', 'questionnaire_respondents.id', '=', 'irrigations.respondent_id')
            ->select([
                ...
                'irrigations.physical_availability_score',
                'irrigations.quality_score',
                'irrigations.suitability_score',
                'irrigations.utilization_score',
                'irrigations.expectation_score',
            ])
