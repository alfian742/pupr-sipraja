...
class TransportationTerminalController extends Controller
{
    /**
     * Key routing (digunakan untuk dynamic route name).
     */
    protected string $key = 'transportation-terminal';

    /**
     * Label jenis infrastruktur (digunakan untuk filtering pertanyaan & view).
     */
    protected string $infrastructureType = 'Prasarana Terminal';

    /**
     * Model yang digunakan oleh controller.
     */
    protected string $model = TransportationTerminal::class;
