<x-app-layout>
    @php $pageTitle = 'Tambah Profil Personel' @endphp
                    ...
                    <div class="card">
                        ...
                        <div class="card-content show collapse">
                            <div class="card-body card-dashboard">
                                ...
                                <form class="form"
                                    action="{{ route('dashboard.organization-profiles.personnel-profiles.store') }}"
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea rows="7" id="personnel_description"
                                                        ...
                                                        name="personnel_description">{{ old('personnel_description') }}</textarea>
                ...
                function initOtherSelect(selectSelector, inputSelector) {
                    ...
                    function toggle() {
                        ...
                        if (selectedValue === 'Lainnya') {
                            ...
                            // Jika kosong (create), biarkan kosong
                            // Jika edit & sudah ada value, jangan diubah
                            ...
                            // Set value dari select jika ada
                            if (selectedValue) {
                    ...
                    // Jalankan saat pertama load (create & edit aman)
                    toggle();
