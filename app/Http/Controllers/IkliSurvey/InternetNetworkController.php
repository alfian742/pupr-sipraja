...
class InternetNetworkController extends Controller
{
    /**
     * Key routing (digunakan untuk dynamic route name).
     */
    protected string $key = 'internet-network';

    /**
     * Label jenis infrastruktur (digunakan untuk filtering pertanyaan & view).
     */
    protected string $infrastructureType = 'Jaringan Telekomunikasi/Internet';

    /**
     * Model yang digunakan oleh controller.
     */
    protected string $model = InternetNetwork::class;
