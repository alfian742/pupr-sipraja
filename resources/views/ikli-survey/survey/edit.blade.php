<x-guest-layout>
    ...
    <section class="content container">
        ...
        <form class="form" action="{{ route('ikli-survey.survey.update', $data->uuid) }}" method="POST"
            id="myForm">
            @csrf
            @method('PUT')
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select id="gender" class="@error('gender') is-invalid @enderror form-select" required
                                name="gender">
                                <option value="" {{ old('gender', $data->gender) ? '' : 'selected' }} disabled>--
                                    Pilih Jenis
                                    Kelamin
                                    --</option>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select id="age" class="@error('age') is-invalid @enderror form-select" required
                                name="age">
                                <option value="" {{ old('age', $data->age) ? '' : 'selected' }} disabled>-- Pilih
                                    Rentang
                                    Usia
                                    --</option>
                                <option value="<20" {{ old('age', $data->age) == '<20' ? 'selected' : '' }}>
                                    &lt;20</option>
                                <option value="20-30" {{ old('age', $data->age) == '20-30' ? 'selected' : '' }}>
                                    20-30</option>
                                <option value="31-40" {{ old('age', $data->age) == '31-40' ? 'selected' : '' }}>
                                    31-40</option>
                                <option value="41-50" {{ old('age', $data->age) == '41-50' ? 'selected' : '' }}>
                                    41-50</option>
                                <option value=">50" {{ old('age', $data->age) == '>50' ? 'selected' : '' }}>
                                    &gt;50</option>
                            </select>
                            @error('age')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select id="education" class="@error('education') is-invalid @enderror form-select" required
                                name="education">
                                <option value="" {{ old('education', $data->education) ? '' : 'selected' }}
                                    disabled>-- Pilih
                                    Pendidikan
                                    Terakhir --
                                </option>
                                ...
                                <option value=">S1"
                                    {{ old('education', $data->education) == '>S1' ? 'selected' : '' }}>&gt;S1
                                </option>
                            </select>
                            @error('education')
                                <div class="invalid-feedback">{{ $message }}</div>
        ...
        <form id="formDestroy" action="{{ $routeList->destroy }}" method="POST" class="d-none">
            @csrf
            @method('DELETE')
        </form>
    </section>
