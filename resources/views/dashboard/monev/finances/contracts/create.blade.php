                    ...
                    <div class="card">
                        ...
                        <div class="card-content show collapse">
                            <div class="card-body card-dashboard">
                                ...
                                <form class="form" action="{{ route('dashboard.monev.finances.contracts.store') }}"
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="activity_description" name="activity_description"
                                                        ...
                                                        placeholder="Contoh: Pengadaan Operasional dan CS (Cleaning Servis) Gedung Kantor">{{ old('activity_description') }}</textarea>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="department" name="department"
                                                        ...
                                                        <option value="BINA MARGA"
                                                            {{ old('department') == 'BINA MARGA' ? 'selected' : '' }}>
                                                            BINA MARGA</option>
                                                        <option value="CIPTA KARYA"
                                                            {{ old('department') == 'CIPTA KARYA' ? 'selected' : '' }}>
                                                            CIPTA KARYA</option>
                                                        <option value="SDA"
                                                            {{ old('department') == 'SDA' ? 'selected' : '' }}>SDA
                                                        </option>
                                                        <option value="SEK"
