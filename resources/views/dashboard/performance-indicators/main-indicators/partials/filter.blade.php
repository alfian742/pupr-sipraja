<div class="col-12">
    <div class="multi-collapse collapse mb-2 {{ $filterApplied ? 'show' : '' }}" id="filterWrapper">
        <div class="bs-callout-info callout-border-left callout-bordered rounded-0 bg-transparent p-1">
            ...
            <form action="{{ route('dashboard.performance-indicators.main-indicators.index') }}" method="GET"
                id="filterForm">
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="d-flex" style="gap: 0.5rem;">
                    ...
                    <a href="{{ route('dashboard.performance-indicators.main-indicators.index') }}" id="btnReset"
            ...
            @if ($filterApplied)
                ...
                <form action="{{ route('dashboard.performance-indicators.main-indicators.export') }}" method="GET"
                    id="exportForm">
                    <div class="row">
                        <div class="col-12">
