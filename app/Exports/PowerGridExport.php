...
class PowerGridExport implements
    FromQuery,
    WithHeadings,
    WithMapping,
    WithColumnFormatting
{
    ...
    {
        $query = PowerGrid::query()
            ->join('questionnaire_respondents', 'questionnaire_respondents.id', '=', 'power_grids.respondent_id')
            ->select([
                ...
                'power_grids.physical_availability_score',
                'power_grids.quality_score',
                'power_grids.suitability_score',
                'power_grids.utilization_score',
                'power_grids.expectation_score',
            ])
