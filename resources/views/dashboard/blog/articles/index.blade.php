                            ...
                            <div class="card-body card-dashboard">
                                ...
                                <div class="d-flex flex-md-row justify-content-between align-items-center mb-2 flex-wrap"
                                    ...
                                    <div class="d-flex align-items-center" style="gap: 0.75rem">
                                        <a href="{{ route('dashboard.blog.articles.create') }}" class="btn btn-indigo">
                                            <i class="fa fa-plus"></i> Tambah
                                        </a>
                                    </div>

                                    <form action="{{ route('dashboard.blog.articles.mass-destroy') }}" method="POST"
        ...
        <script>
            $(document).ready(function() {
                const table = $('.table-custom').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('dashboard.blog.articles.data') }}",
                    columns: [{
                            data: 'action',
                            orderable: false,
                            searchable: false,
