                    ...
                    <div class="card">
                        ...
                        <div class="card-content show collapse">
                            <div class="card-body card-dashboard">
                                ...
                                <form class="form"
                                    action="{{ route('dashboard.other-informations.faqs.update', $data->id) }}"
                                    ...
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <textarea id="faq_question" class="form-control @error('faq_question') is-invalid @enderror"
                                                placeholder="Masukkan pertanyaan" name="faq_question">{{ old('faq_question', $data->faq_question) }}</textarea>
                                            @error('faq_question')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="faq_answer" class="form-control ckeditor @error('faq_answer') is-invalid @enderror"
                                                placeholder="Masukkan jawaban" name="faq_answer">{{ old('faq_answer', $data->faq_answer) }}</textarea>
                                            @error('faq_answer')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
