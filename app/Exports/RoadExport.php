    ...
    WithColumnFormatting
{
    ...
    {
        $query = Road::query()
            ->join('questionnaire_respondents', 'questionnaire_respondents.id', '=', 'roads.respondent_id')
            ->select([
                ...
                'roads.physical_availability_score',
                'roads.quality_score',
                'roads.suitability_score',
                'roads.utilization_score',
                'roads.expectation_score',
            ])
