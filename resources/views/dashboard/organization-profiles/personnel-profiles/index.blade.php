                            ...
                            <div class="card-body card-dashboard">
                                ...
                                <div class="d-flex flex-md-row justify-content-between align-items-center mb-2 flex-wrap"
                                    ...
                                    <div class="d-flex align-items-center" style="gap: 0.75rem">
                                        <a href="{{ route('dashboard.organization-profiles.personnel-profiles.create') }}"
                                    ...
                                    <form
                                        action="{{ route('dashboard.organization-profiles.personnel-profiles.mass-destroy') }}"
        ...
        <script>
            $(document).ready(function() {
                const table = $('.table-custom').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('dashboard.organization-profiles.personnel-profiles.data') }}",
                    columns: [{
                            data: 'action',
                            orderable: false,
                            searchable: false,
