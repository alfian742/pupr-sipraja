                    ...
                    <div class="card">
                        ...
                        <div class="card-content show collapse">
                            <div class="card-body card-dashboard">
                                ...
                                <form class="form" action="{{ route('dashboard.monev.finances.ls-payments.store') }}"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="document_description" name="document_description"
                                                        ...
                                                        placeholder="Contoh: Pembayaran UMK 30% (Tiga puluh persen) pada Pekerjaan Pengadaan Operasional dan CS (Cleaning Servis) Gedung Kantor An. PT. SAKRA JAYA UTAMA. DANA PAD.">{{ old('document_description') }}</textarea>
