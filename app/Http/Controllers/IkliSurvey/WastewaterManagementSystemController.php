...
class WastewaterManagementSystemController extends Controller
{
    /**
     * Key routing (digunakan untuk dynamic route name).
     */
    protected string $key = 'wastewater-management-system';

    /**
     * Label jenis infrastruktur (digunakan untuk filtering pertanyaan & view).
     */
    protected string $infrastructureType = 'Prasarana Air Limbah';

    /**
     * Model yang digunakan oleh controller.
     */
    protected string $model = WastewaterManagementSystem::class;
