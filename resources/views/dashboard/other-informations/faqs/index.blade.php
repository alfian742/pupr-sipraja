                            ...
                            <div class="card-body card-dashboard">
                                ...
                                <div class="d-flex flex-md-row justify-content-between align-items-center mb-2 flex-wrap"
                                    ...
                                    <div class="d-flex align-items-center" style="gap: 0.75rem">
                                        <a href="{{ route('dashboard.other-informations.faqs.create') }}"
                                            class="btn btn-indigo">
                                            <i class="fa fa-plus"></i> Tambah
                                        </a>
                                    </div>

                                    <form action="{{ route('dashboard.other-informations.faqs.mass-destroy') }}"
                                ...
                                <div class="table-responsive">
                                    <table class="table-striped table-bordered table-custom table-align-middle table">
                                        @php
                                            $column = ['No.', 'Pertanyaan', 'Jawaban', 'Riwayat'];
                                        @endphp
        ...
        <script>
            $(document).ready(function() {
                const table = $('.table-custom').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('dashboard.other-informations.faqs.data') }}",
                    columns: [{
                            data: 'action',
                            orderable: false,
                            searchable: false
