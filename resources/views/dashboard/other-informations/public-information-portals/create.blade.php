<x-app-layout>
    @php $pageTitle = 'Tambah Portal Informasi Publik' @endphp
                    ...
                    <div class="card">
                        ...
                        <div class="card-content show collapse">
                            <div class="card-body card-dashboard">
                                ...
                                <form class="form"
                                    action="{{ route('dashboard.other-informations.public-information-portals.store') }}"
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="portal_name"
                                                        ...
                                                        name="portal_name" value="{{ old('portal_name') }}">
                                                    @error('portal_name')
