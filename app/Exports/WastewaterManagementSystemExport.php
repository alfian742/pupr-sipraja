...
class WastewaterManagementSystemExport implements
    FromQuery,
    WithHeadings,
    WithMapping,
    WithColumnFormatting
{
    ...
    {
        $query = WastewaterManagementSystem::query()
            ->join('questionnaire_respondents', 'questionnaire_respondents.id', '=', 'wastewater_management_systems.respondent_id')
            ->select([
                ...
                'wastewater_management_systems.physical_availability_score',
                'wastewater_management_systems.quality_score',
                'wastewater_management_systems.suitability_score',
                'wastewater_management_systems.utilization_score',
                'wastewater_management_systems.expectation_score',
            ])
