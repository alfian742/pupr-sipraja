...
class TransportationTerminalExport implements
    FromQuery,
    WithHeadings,
    WithMapping,
    WithColumnFormatting
{
    ...
    {
        $query = TransportationTerminal::query()
            ->join('questionnaire_respondents', 'questionnaire_respondents.id', '=', 'transportation_terminals.respondent_id')
            ->select([
                ...
                'transportation_terminals.physical_availability_score',
                'transportation_terminals.quality_score',
                'transportation_terminals.suitability_score',
                'transportation_terminals.utilization_score',
                'transportation_terminals.expectation_score',
            ])
