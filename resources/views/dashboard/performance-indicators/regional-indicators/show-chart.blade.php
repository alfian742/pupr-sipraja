                        ...
                        <div class="card-content show collapse">
                            <div class="card-body card-dashboard">
                                ...
                                <div>
                                    ...
                                    <h6 class="mb-0" id="regional-indicator-unit">Satuan: -</h6>
                                </div>

                                <div id="regional-indicator-chart-wrapper">
                                    <div style="height: 300px;">
                                        <canvas id="regional-indicator-chart" class="h-100"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    @push('scripts')
        ...
        <script>
            ...
            function ensureWrapperRelative() {
                const wrapper = document.getElementById('regional-indicator-chart-wrapper');
            ...
            function updateHeader(data) {
                document.getElementById('regional-indicator-title').innerText = data?.title ?? 'Indikator';
                document.getElementById('regional-indicator-unit').innerText = `Satuan: ${data?.unit ?? '-'}`;
            }

            function renderOrUpdateChart(data) {
                const canvas = document.getElementById('regional-indicator-chart');
                if (!canvas) return;
            ...
            async function loadIndicatorChart(indicatorName) {
                ...
                try {
                    ...
                    const res = await fetch(`${REGIONAL_INDICATOR_CONFIG.chartUrl}?${params.toString()}`, {
                        headers: {
            ...
            document.addEventListener('DOMContentLoaded', function() {
                const nameSelect = document.getElementById('regional-indicator-name-select');
