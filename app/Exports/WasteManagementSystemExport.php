...
class WasteManagementSystemExport implements
    FromQuery,
    WithHeadings,
    WithMapping,
    WithColumnFormatting
{
    ...
    {
        $query = WasteManagementSystem::query()
            ->join('questionnaire_respondents', 'questionnaire_respondents.id', '=', 'waste_management_systems.respondent_id')
            ->select([
                ...
                'waste_management_systems.physical_availability_score',
                'waste_management_systems.quality_score',
                'waste_management_systems.suitability_score',
                'waste_management_systems.utilization_score',
                'waste_management_systems.expectation_score',
            ])
